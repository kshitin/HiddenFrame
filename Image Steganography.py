...
class IMG_Stegno:
    ...
    def main(self, root):
        root.title('Image Steganography by Kshitin ')
        ...
        title = Label(frame,text='Welcome To HiddenFrame !')
        title.config(font=('Times new roman',25, 'italic'))
        title.grid(pady=50)
